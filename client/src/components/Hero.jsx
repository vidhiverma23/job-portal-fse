  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
      ...
      <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
        ...
        <div className='flex items-center gap-3 bg-white rounded text-gray-600 max-w-xl p-2 mx-4 sm:mx-auto'>
          ...
          <button
            onClick={onSearch}
            className='bg-blue-600 px-6 py-2 rounded text-white whitespace-nowrap'
          >
            Search
          </button>
        </div>
